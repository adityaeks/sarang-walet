    ...
    <div class="row">
        <div class="card">
            <div class="card-body">
                ...
                <a href="{{ route('about.create') }}" class="btn btn-lg bg-gradient-success mb-3" data-bs-toggle="modal" data-bs-target="#addDataModal">Add Data</a>
                            ...
                            <div class="modal-body">
                                ...
                                <form action="{{ route('about.store') }}" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control @error('content') is-invalid @enderror" name="content" value="{{ old('content') }}" placeholder="Masukkan Judul Post">
                    ...
                    <table class="table" id="alldata">
                        <thead class="text-center text-dark">
                            <tr>
                                ...
                                <th class="fs-4" scope="col">Tile</th>
                                <th class="fs-4" scope="col">Content</th>
                        ...
                        <tbody class="text-center">
                            @foreach ($data as $item)
                                <tr>
                                    ...
                                    <th scope="row">
                                        <img src="{{ asset('/storage/images/about/'.$item->image) }}" class="rounded" style="width: 16%">
                                    </th>
                                    <th class="fs-5" scope="row">{{ $item->title }}</th>
                                    <th class="fs-5" scope="row">{{ $item->content }}</th>
                                    <th>
                                        <div class="d-flex justify-content-center">
                                                    ...
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body">
                                                            ...
                                                            <form action="{{ route('about.update', $item->id) }}" method="POST" enctype="multipart/form-data">
                                                                ...
                                                                <div class="form-group">
                                                                    <label class="font-weight-bold">Title</label>
                                                                    <input type="text" class="form-control @error('title') is-invalid @enderror" name="title" value="{{ old('title', $item->title) }}" placeholder="Masukkan Judul Post">
                                                                    <!-- error message untuk title -->
                                                                    @error('title')
                                                                        <div class="alert alert-danger mt-2">{{ $message }}</div>
                                                                    @enderror
                                                                ...
                                                                <div class="form-group">
                                                                    <label class="font-weight-bold">Content</label>
                                                                    <input type="text" class="form-control @error('content') is-invalid @enderror" name="content" value="{{ old('content', $item->content) }}" placeholder="Masukkan Judul Post">
                                                                    <!-- error message untuk content -->
                                                                    @error('content')
                                                                        <div class="alert alert-danger mt-2">{{ $message }}</div>
                                                                    @enderror
                                            ...
                                            <form  onsubmit="return confirm('Are you sure want to delete it ?');" action="{{ route('about.delete', $item->id) }}" method="post"">
                                                @csrf
                                                @method('DELETE')
