...
<div class="row">
    <div class="card">
        <div class="card-body">
            ...
            <a href="{{ route('product.create') }}" class="btn btn-lg bg-gradient-success mb-3" data-bs-toggle="modal" data-bs-target="#addDataModal">Add Product</a>
                        ...
                        <div class="modal-body">
                            ...
                            <form action="{{ route('product.store') }}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control @error('category') is-invalid @enderror" name="category" value="{{ old('category') }}" placeholder="Masukkan Kategori">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control @error('price') is-invalid @enderror" name="price" value="{{ old('price') }}" placeholder="ex : 1000000">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control @error('count') is-invalid @enderror" name="count" value="{{ old('count') }}" placeholder="ex : 10">
                            ...
                            <tr>
                                ...
                                <th>
                                    <div class="d-flex justify-content-center">
                                        ...
                                        <!-- Info Data Modal -->
                                        <div class="modal fade" id="infoDataModal{{ $item->id }}" tabindex="-1" aria-labelledby="infoDataModalLabel" aria-hidden="true">
                                            <div class="modal-dialog modal-dialog-centered modal-lg">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        <h5 class="modal-title" id="infoDataModalLabel">Info Product</h5>
                                                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                                    </div>
                                                    <div class="modal-body">
                                                        <div class="container">
                                                                ...
                                                                <div class="col-md-8">
                                                                    <div class="card border-0 shadow-sm rounded">
                                                                        <div class="card-body">
                                                                            ...
                                                                            <img src="{{ asset('/storage/images/product/'.$item->image) }}" class="w-100 rounded">
                                                                            <hr>
                                                                            <h4>{{ $item->name }}</h4>
                                                                            <p class="tmt-3">
                                                                                {!! $item->description !!}
                                                ...
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        ...
                                                        <form action="{{ route('product.update', $item->id) }}" method="POST" enctype="multipart/form-data">
                                                            ...
                                                            <div class="form-group">
                                                                <label class="font-weight-bold">Description</label>
                                                                <input type="text" class="form-control @error('description') is-invalid @enderror" name="description" value="{{ old('description', $item->description) }}" placeholder="Masukkan Judul Post">
                                                                <!-- error message untuk description -->
                                                                @error('description')
                                                                    <div class="alert alert-danger mt-2">{{ $message }}</div>
                                                                @enderror
                                                            ...
                                                            <div class="form-group">
                                                                <label class="font-weight-bold">Category</label>
                                                                <input type="text" class="form-control @error('category') is-invalid @enderror" name="category" value="{{ old('category', $item->category) }}" placeholder="Masukkan Judul Post">
                                                                <!-- error message untuk category -->
                                                                @error('category')
                                                                    <div class="alert alert-danger mt-2">{{ $message }}</div>
                                                                @enderror
                                                            ...
                                                            <div class="form-group">
                                                                <label class="font-weight-bold">Price</label>
                                                                <input type="text" class="form-control @error('price') is-invalid @enderror" name="price" value="{{ old('price', $item->price) }}" placeholder="Masukkan Judul Post">
                                                                <!-- error message untuk price -->
                                                                @error('price')
                                                                    <div class="alert alert-danger mt-2">{{ $message }}</div>
                                                                @enderror
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" class="form-control @error('count') is-invalid @enderror" name="count" value="{{ old('count', $item->count) }}" placeholder="Masukkan Judul Post">
                                                                <!-- error message untuk count -->
                                                                @error('count')
                                                                    <div class="alert alert-danger mt-2">{{ $message }}</div>
                                                                @enderror
